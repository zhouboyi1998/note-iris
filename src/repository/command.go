...
func Collection(ctx iris.Context) *mongo.Collection {
	// 从配置文件中读取连接配置
	uri := "mongodb://" +
...
// One 根据id查询命令
func One(ctx iris.Context) model.Command {
	// 获取集合连接
	collection := Collection(ctx)

	// 获取命令id参数
	commandId := ctx.Params().Get("commandId")
	// 转换成文档id
...
// List 查询命令列表
func List(ctx iris.Context) []model.Command {
	// 获取集合连接
	collection := Collection(ctx)
...
// Insert 新增命令
func Insert(ctx iris.Context) (*mongo.InsertOneResult, string) {
	// 获取集合连接
	collection := Collection(ctx)

	// 获取请求体参数
	var command model.Command
	errBind := ctx.ReadBody(&command)
	if errBind != nil {
		log.Println(errBind)
	}
	// 生成文档id
...
// InsertBatch 批量新增命令
func InsertBatch(ctx iris.Context) *mongo.InsertManyResult {
	// 获取集合连接
	collection := Collection(ctx)

	// 获取请求体参数
	var commandList []interface{}
	errBind := ctx.ReadBody(&commandList)
	if errBind != nil {
		log.Println(errBind)
	}
...
// Update 修改命令
func Update(ctx iris.Context) *mongo.UpdateResult {
	// 获取集合连接
	collection := Collection(ctx)
...
// UpdateBatch 批量修改命令
func UpdateBatch(ctx iris.Context) []*mongo.UpdateResult {
	// 获取集合连接
	collection := Collection(ctx)

	// 获取请求体参数
	var commandArray []model.Command
	errBind := ctx.ReadBody(&commandArray)
	if errBind != nil {
		log.Println(errBind)
	}
...
// Delete 删除命令
func Delete(ctx iris.Context) (*mongo.DeleteResult, primitive.ObjectID) {
	// 获取集合连接
	collection := Collection(ctx)
...
// DeleteBatch 批量删除命令
func DeleteBatch(ctx iris.Context) (*mongo.DeleteResult, []primitive.ObjectID) {
	// 获取集合连接
	collection := Collection(ctx)

	// 获取请求体参数
	var commandIds []string
	errBind := ctx.ReadBody(&commandIds)
	if errBind != nil {
		log.Println(errBind)
	}
...
// Select 查询命令
func Select(ctx iris.Context) model.Command {
	// 获取集合连接
	collection := Collection(ctx)
...
// NameList 查询命令名称列表
func NameList(ctx iris.Context) []string {
	// 获取集合连接
	collection := Collection(ctx)
